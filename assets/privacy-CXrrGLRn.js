import{M as a}from"./style-BbBHMDXQ.js";import{d as r,D as i,t as n,x as s,C as c}from"./index-CFAQHEIK.js";const o=`**Privacy Policy**
==================
...
*   when you visit and/or use our App;
*   when you complete our registration form;
*   when you log in to our app using an authentication system;
*   when you post materials or upload content;
*   when you participate in chat sessions;
*   when you take part in surveys or report a problem with our App; and/or
...
(c) Personal data we collect and process from Models All personal data we collect from Members, set out in paragraph 4(b) above;
...
(b) Legitimate interests (1) Customization of content (Members Only)
...
In addition to the above, we may process your data, to the extent required for our business needs in order to: 1) develop new services on our Website as well as analyze and target new markets; 2) protect our legal rights and interests (including legal claims and preparing our defense in litigation); 3) monitor, maintain and improve internal business processes, information and data, technology and communication solutions and services; 4) ensure network information security, including monitoring Browsers’ and Members’ access to our information technology for the purpose of preventing cyber-attacks, unauthorized use of Website and prevention or detection of crime; 5) send you relevant marketing information (including details of other services provided by us which we believe may be of interest to you), but only where you are Members of the Website (For more information, see “Choices About How We Collect, Use and Disclose Your Personal Information”); 6) monitor the performance and effectiveness of our services and the Website; and 7) assess the quality of our customer services. (c) For compliance with legal obligations When you visit and/or use and/or register in our Website (and throughout your relationship with us), we are required to comply with certain legal and regulatory obligations which may involve the processing of your personal data. This may include processing to: 1) perform checks and comply with laws relating to fraud; 2) identify other infringements of our Terms of Use; and 3) manage contentious regulatory matters, investigations and litigation. (d) You have provided your consent We will ask for your consent when we wish to provide marketing information to you in relation to our services which we believe may be of interest and of benefit to you, but only where you are a Browser.
...
*   (e) legal or other professional consultants. We may also disclose aggregated information about our users, and information that does not identify any individual, without restriction. We also may share aggregated information with third-parties for conducting general business analysis. This information does not contain any personal data and may be used to develop content and services that we hope you and other users will find of interest and to target content and advertising.
...
If you have questions about our data retention practices, please contact us electronically by sending as an email at [twistcam@protonmail.com](twistcam@protonmail.com).
...
Right to object: You have the right to object to processing of your personal data where we are relying on a legitimate interest and there is something about your particular situation which makes you want to object to processing on this ground. If you exercise your right to object, we will no longer process your personal data unless we can demonstrate compelling legitimate grounds for the processing which override your interests, rights and freedom or for the establishment, exercise and defense of legal claims. You also have the right to object where we are processing your personal data for direct marketing purposes. This also includes profiling in as much as it is related to direct marketing.
...
*   b) if you are a Model, choose whether the photos, videos and albums you have uploaded are visible to everyone or to Members and/or Models or to friends only by changing the settings in your profile;
*   c) control who you disclose the information to through social networks, comments and PMs on the Website; or
*   d) block cookies, including cookies associated with our services, by activating or deactivating the related cookies on your browser. Please note, however, that if you choose to disable all cookies (including essential cookies) you may not be able to access all or part of our Website. Please see our Cookies Policy for more information.

15. Our communication with you
-------------------------------

If you have any questions about this privacy policy or our information-handling practices, please contact us electronically at twistcam@protonmail.com or by post at .
...
`,u=r({__name:"privacy",setup(l){return(d,e)=>(s(),i(n(a),{modelValue:o,"onUpdate:modelValue":e[0]||(e[0]=t=>o=t),class:"md-preview-container"}))}}),y=c(u,[["__scopeId","data-v-b509a187"]]);export{y as default};
