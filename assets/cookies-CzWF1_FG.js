import{M as a}from"./style-BbBHMDXQ.js";import{d as r,D as i,t as n,x as s,C as c}from"./index-CFAQHEIK.js";const o=`Cookies Policy
==============
...
*   is directed to individuals who are: (a) visitors of the Website (referred to in this privacy policy as **“Browsers”**); (b) individuals who have registered as members of the Website by creating their own account (referred to in this privacy policy as **“Members”**); (c) individuals who have registered as models (referred to in this privacy policy as **“Models”**). Browsers, Members and Models must be aged eighteen (18) years and over or must have attained the age of majority in their respective jurisdiction in order to be able to use the Website. All persons who do not meet these criteria are strictly forbidden from accessing, viewing the contents of, or otherwise joining the Website. We do not knowingly seek or collect any personal information from persons who have not attained the age of eighteen (18); and
...
If you have any questions, comments and/or requests regarding this privacy policy or wish to obtain more details in relation to the personal data we process about you, please contact us by sending an email to [twistcam@protonmail.com.](mailto:twistcam@protonmail.com)
...
You have the right to object at any time to the processing of your personal data for marketing purposes, by sending us an email at [twistcam@protonmail.com](mailto:twistcam@protonmail.com) or by clicking at the opt-out link at the bottom of any marketing emails we send you.
...
15. How long we keep your personal data for
--------------------------------------------
...
If you have questions about our data retention practices, please contact us electronically by sending as an email at [twistcam@protonmail.com](mailto:twistcam@protonmail.com).
...
To exercise any of your rights, or if you have any other questions about our use of your personal data, please contact us electronically by sending us an email at [twistcam@protonmail.com](mailto:twistcam@protonmail.com) or by post at .
...
*   b) choose whether your profile/uploaded content is visible to everyone, or to Members and/or Models or to friends only on [./settings;](https://./settings)
*   c) if you are a Model, choose whether the photos, videos and albums you have uploaded are visible to everyone or to Members and/or Models or to friends only by changing the settings in your profile;
...
18. Choices About How We Collect, Use and Disclose Your Personal Information
-----------------------------------------------------------------------------
...
If you have any questions about this privacy policy or our information-handling practices, please contact us electronically at [twistcam@protonmail.com](mailto:twistcam@protonmail.com) or by post at .

20. Right to complain
----------------------

If you wish to lodge a complaint about how your personal data is used by the Company, you may contact us electronically at the email address [twistcam@protonmail.com](mailto:twistcam@protonmail.com) or by post at .
...
Although we will notify you when major changes are made to this privacy policy, you are expected to periodically review the most up-to-date version found at [./privacy](https://./privacy) so you are aware of any changes. The date of the latest version of the privacy policy will appear at the top of the webpage hosting the policy.
...
We do not guarantee error-free performance under this privacy policy. We will use reasonable efforts to comply with this privacy policy and will take prompt corrective action when we learn of any failure to comply with our privacy policy. We shall not be liable for any incidental, consequential or punitive damages relating to this privacy policy.`,u=r({__name:"cookies",setup(l){return(d,e)=>(s(),i(n(a),{modelValue:o,"onUpdate:modelValue":e[0]||(e[0]=t=>o=t),class:"md-preview-container"}))}}),p=c(u,[["__scopeId","data-v-5b39e3d8"]]);export{p as default};
